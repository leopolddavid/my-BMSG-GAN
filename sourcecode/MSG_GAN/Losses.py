...
class RelativisticAverageHingeGAN(GANLoss):
    ...
    def gen_loss(self, real_samps, fake_samps):
        ...
        # todo: try to add this in the loss, to regularize / reduce the bumpiness on x and y axis of the images generated by the gen
        # print(fake_samps[5].shape)
        # loss_x = th.abs(fake_samps[5][:, :, :-1, :] - fake_samps[5][:, :, 1:, :]).mean()
        # loss_y = th.abs(fake_samps[5][:, :, :, :-1] - fake_samps[5][:, :, :, 1:]).mean()
        # loss = loss_x + loss_y
